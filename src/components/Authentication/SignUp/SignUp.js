                ...
                <div>
                    <div className='m-10'>
                        <form onSubmit={handleSubmit(handleLogin)}>
                            ...
                            <div className="form-control w-full my-5">
                                <div className='flex justify-start items-center'>
                                    <div className='flex justify-center items-center'>
                                        <input {...register('role')}
                                            id="user_type_instructor" type="radio" name="radio-2" className="radio radio-primary" value="instructor" />
                                        <label className='ml-2'
                                            for="user_type_instructor">Instructor</label>
                                    </div>
                                    <div class="ml-5 flex justify-center items-center">
                                        <input {...register('role')}
                                            id="user_type_student" type="radio" name="radio-2" className="radio radio-primary" value="student" />
                                        <label className='ml-2'
                                            for="user_type_student">Student</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-center items-center border-2 rounded-md p-3 cursor-pointer hover:bg-gray-50">
