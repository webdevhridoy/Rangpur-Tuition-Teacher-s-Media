            ...
            <div className='grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-5 py-5'>
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
                    ...
                    <div className="absolute inset-0 flex translate-y-[40%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h1 className="font-dmserif text-xl font-bold text-white">Science</h1>
                        <h3 className="font-dmserif text-sm font-bold text-white">Total Tutions: 20</h3>
                        <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">We have 20 tutions for you. Don't missed out to take them.</p>
                        <Link to='/signup'>
                ...
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
                    <div className="absolute inset-0 flex translate-y-[40%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h1 className="font-dmserif text-xl font-bold text-white">Commerce</h1>
                        <h3 className="font-dmserif text-sm font-bold text-white">Total Tutions: 20</h3>
                        <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">We have 20 tutions for you. Don't missed out to take them.</p>
                        <Link to='/signup'>
                            <button className="text-white border border-white hover:border-secondary  px-2 py-1 hover:bg-gradient-to-r from-secondary to-primary hover:text-white">Read More</button>
                ...
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
                    <div className="absolute inset-0 flex translate-y-[40%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h1 className="font-dmserif text-xl font-bold text-white">Humanities</h1>
                        <h3 className="font-dmserif text-sm font-bold text-white">Total Tutions: 20</h3>
                        <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">We have 20 tutions for you. Don't missed out to take them.</p>
                        <Link to='/signup'>
                            <button className="text-white border border-white hover:border-secondary  px-2 py-1 hover:bg-gradient-to-r from-secondary to-primary hover:text-white">Read More</button>
                ...
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
                    <div className="absolute inset-0 flex translate-y-[40%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h1 className="font-dmserif text-xl font-bold text-white">ICT</h1>
                        <h3 className="font-dmserif text-sm font-bold text-white">Total Tutions: 20</h3>
                        <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">We have 20 tutions for you. Don't missed out to take them.</p>
                        <Link to='/signup'>
                            <button className="text-white border border-white hover:border-secondary  px-2 py-1 hover:bg-gradient-to-r from-secondary to-primary hover:text-white">Read More</button>
                ...
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
                    <div className="absolute inset-0 flex translate-y-[40%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                        <h1 className="font-dmserif text-xl font-bold text-white">English</h1>
                        <h3 className="font-dmserif text-sm font-bold text-white">Total Tutions: 20</h3>
                        <p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">We have 20 tutions for you. Don't missed out to take them.</p>
                        <Link to='/signup'>
                            <button className="text-white border border-white hover:border-secondary  px-2 py-1 hover:bg-gradient-to-r from-secondary to-primary hover:text-white">Read More</button>
