...
const InstructorsGrid = () => {
    return (
        <div className='flex flex-col justify-evenly items-center w-11/12 mx-auto p-5 md:p-10'>
            <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 justify-evenly items-center py-5 hover14'>
