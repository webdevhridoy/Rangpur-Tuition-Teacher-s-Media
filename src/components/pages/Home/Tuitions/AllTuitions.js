...
const AllTuitions = () => {
    return (
        <div className="w-11/12 mx-auto p-5">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-between items-center md:gap-8 gap-2'>
                <div className="py-5 border hover:shadow-lg duration-700 px-2 md:px-4 mt-5">
