...
const InstructorsReviews = () => {
    return (
        <div className='p-5 border rounded-md bg-white'>
            <div>
                <h2 className='text-start text-xl font-bold text-primary  uppercase'>Reviews</h2>
                <p className='text-start pb-5'>You have full control to manage your own account setting.
                </p>
            </div>
...
export default InstructorsReviews;